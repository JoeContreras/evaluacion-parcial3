...
<body class="animsition">
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" name="myForm">
                                    <div class="form-group" id="lote-div">
                                        ...
                                        <input type="text" id="nf-email" name="fLote" placeholder="no. lote" class="form-control" pattern="\d*" maxlength="5">
                                    </div>
                                    <div class="form-group" id="nombre-div">
                                        <label for="nf-password" class=" form-control-label">Nombre del Responsable</label>
                                        <input type="text" id="nf-password" name="fNombre" placeholder="Nombre" class="form-control" >
                                    </div>
                                    <div class="form-group" id="apellido-div">
                                        <label for="nf-password" class=" form-control-label">Apellido del Responsable</label>
                                        <input type="text" id="nf-password" name="fApellido" placeholder="Apellido" class="form-control" >
                                    </div>
                                    <div class="form-group" id="inicio-div">
                                        <label for="nf-password" class=" form-control-label">Fecha de inicio de producción</label>
                                        <input type="date" id="nf-password" name="fInicio" placeholder="Fecha inicio" class="form-control" >
                                    </div>
                                    <div class="form-group" id="termino-div">
                                        ...
                                        <input type="date" id="nf-password" name="fTermino" placeholder="Fecha Terminacion" class="form-control" >
                                    </div>
                                    ...
                                    <div class="form-group" id="num-div">
                                        ...
                                        <input type="number" id="nf-password" name="fNum" placeholder="no. piezas" class="form-control" min="0" max="999">
                                    </div>
                                    <div class="form-group" id="def-div">
                                        <label for="nf-password" class=" form-control-label">Número de piezas defectuosas</label>
                                        <input type="number" id="nf-password" name="fDef" placeholder="no. piezas defectuosas" class="form-control" min="0" max="999">
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-sm" onclick="event.preventDefault(); validateForm()">Submit</button>
    ...
    <script src="./js/registro-vendedor.js"></script>
    <!-- Bootstrap JS-->
